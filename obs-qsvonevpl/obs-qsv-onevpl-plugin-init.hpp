...
#define TEXT_CHROMA_QP_OFFSET obs_module_text("CHROMA_QP_OFFSET")
#define TEXT_QUANT_MATRIX obs_module_text("QUANT_MATRIX")
#define TEXT_QUANT_MATRIX_DEFAULT obs_module_text("QUANT_MATRIX_DEFAULT")
#define TEXT_QUANT_MATRIX_FLAT16 obs_module_text("QUANT_MATRIX_FLAT16")
#define TEXT_QUANT_MATRIX_JM obs_module_text("QUANT_MATRIX_JM")
#define TEXT_QUANT_MATRIX_DETAIL obs_module_text("QUANT_MATRIX_DETAIL")
#define TEXT_QUANT_MATRIX_EDGE obs_module_text("QUANT_MATRIX_EDGE")
...
#define TEXT_QM_GRAN_4 obs_module_text("QM_GRAN_4")
#define TEXT_QM_GRAN_FULL obs_module_text("QM_GRAN_FULL")
#define TEXT_QM_BOX_DESC obs_module_text("QM_BOXDesc")
#define TEXT_QM_4X4 obs_module_text("QM_4X4")
#define TEXT_QM_8X8 obs_module_text("QM_8X8")
#define TEXT_QM_I4 obs_module_text("QM_I4")
#define TEXT_QM_P4 obs_module_text("QM_P4")
#define TEXT_QM_I8 obs_module_text("QM_I8")
#define TEXT_QM_P8 obs_module_text("QM_P8")
#define TEXT_QM_I4Y obs_module_text("QM_I4Y")
#define TEXT_QM_P4Y obs_module_text("QM_P4Y")
#define TEXT_QM_I8Y obs_module_text("QM_I8Y")
#define TEXT_QM_P8Y obs_module_text("QM_P8Y")
#define TEXT_QM_CI4 obs_module_text("QM_CI4")
#define TEXT_QM_CP4 obs_module_text("QM_CP4")
...
#define TEXT_CHROMA_QP_OFFSET_DESC obs_module_text("CHROMA_QP_OFFSETDesc")
#define TEXT_QUANT_MATRIX_DESC obs_module_text("QUANT_MATRIXDesc")
